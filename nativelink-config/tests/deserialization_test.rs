...
// Add more tests for other functions like convert_vec_string_with_shellexpand, convert_duration_with_shellexpand, etc.

//  add optional_numeric
...
//convert_string with shellexpand
#[derive(Deserialize)]
struct StringEntity {
